...
XPI_NORMANDY_PRIVILEGED_LDAP_GROUP = ["xpi_normandy_admin"]
...
LDAP_GROUPS = {
    ...
    "xpi_privileged_build": XPI_PRIVILEGED_BUILD_LDAP_GROUP,
    ...
    "xpi_normandy-privileged_signoff": XPI_NORMANDY_PRIVILEGED_LDAP_GROUP + ADMIN_LDAP_GROUP,
}
