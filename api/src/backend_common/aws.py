...
class AWS(object):
    ...
    def connect_to_default(self, service_name, region_name):
        ...
        return connect_fn(aws_access_key_id=self.config.get("access_key_id"), aws_secret_access_key=self.config.get("secret_access_key"), region=region)
    ...
    def connect_to_s3(self, service_name, region_name):
        ...
        return boto.s3.connect_to_region(
            region_name=region_name, aws_access_key_id=self.config.get("access_key_id"), aws_secret_access_key=self.config.get("secret_access_key")
        )
