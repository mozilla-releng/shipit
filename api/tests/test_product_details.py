...
async def test_rebuild(app, tmp_path):
    ...
    nightly_build_1 = NightlyRelease(product="firefox", channel="nightly", version="134.0a1", buildid="20241101093000", locales=list(L10N_CHANGESETS.keys()))
    nightly_build_2 = NightlyRelease(
        product="firefox", channel="nightly", version="135.0a1", buildid="20241225093000", locales=list(L10N_CHANGESETS.keys()) + ["zz"]
    )
...
def test_get_firefox_locales():
    nightly_releases = [
        NightlyRelease(product="firefox", channel="nightly", version="55.0a1", buildid="20170100000000", locales=["af", "de"]),
        NightlyRelease(product="firefox", channel="nightly", version="6.0a1", buildid="20110100000000", locales=["af", "de"]),
        NightlyRelease(product="firefox", channel="nightly", version="56.0a1", buildid="20170200000000", locales=["af", "de", "fr"]),
        NightlyRelease(product="firefox", channel="nightly", version="40.0a1", buildid="20150100000000", locales=["de"]),
    ]
    releases = []
