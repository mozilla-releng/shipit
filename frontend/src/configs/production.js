    ...
    firefox: [
      {
        ...
        branches: [
          ...
          {
            prettyName: 'ESR153',
            project: 'mozilla-esr153',
            branch: 'releases/mozilla-esr153',
            repo: 'https://hg.mozilla.org/releases/mozilla-esr153',
            enableReleaseEta: true,
            numberOfPartials: 5,
            alternativeBranch: 'releases/mozilla-esr140',
            alternativeRepo: 'https://hg.mozilla.org/releases/mozilla-esr140',
            disableable: false,
          },
          {
            prettyName: 'ESR140',
            project: 'mozilla-esr140',
            branch: 'releases/mozilla-esr140',
            repo: 'https://hg.mozilla.org/releases/mozilla-esr140',
            enableReleaseEta: true,
            numberOfPartials: 5,
            alternativeBranch: 'releases/mozilla-esr128',
            alternativeRepo: 'https://hg.mozilla.org/releases/mozilla-esr128',
            disableable: false,
          },
          {
            prettyName: 'ESR115',
    ...
    thunderbird: [
      {
        ...
        branches: [
          ...
          },
          {
            prettyName: 'ESR153',
            project: 'comm-esr153',
            branch: 'releases/comm-esr153',
            repo: 'https://hg.mozilla.org/releases/comm-esr153',
            alternativeBranch: 'releases/comm-esr140',
            alternativeRepo: 'https://hg.mozilla.org/releases/comm-esr140',
            enableReleaseEta: false,
            disableable: false,
          },
          {
            prettyName: 'ESR140',
            project: 'comm-esr140',
            branch: 'releases/comm-esr140',
            repo: 'https://hg.mozilla.org/releases/comm-esr140',
            alternativeBranch: 'releases/comm-esr128',
            alternativeRepo: 'https://hg.mozilla.org/releases/comm-esr128',
            enableReleaseEta: false,
            disableable: false,
          },
        ],
